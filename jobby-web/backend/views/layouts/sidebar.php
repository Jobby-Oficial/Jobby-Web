        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte\widgets\Menu::widget([
                'items' => [
                    ...
                    ['label' => 'Gestão do JOBBY', 'header' => true],
                    ['label' => 'Utilizadores',  'icon' => 'file-code', 'url' => ['user/index'], 'visible' => \Yii::$app->user->can('indexUserBackoffice')],
                    ['label' => 'Serviços',  'icon' => 'file-code', 'url' => ['service/index'], 'visible' => \Yii::$app->user->can('indexServiceBackoffice')],
                    ['label' => 'Avaliações',  'icon' => 'file-code', 'url' => ['avaliation/index'], 'visible' => \Yii::$app->user->can('indexAvaliationBackoffice')],
                    ['label' => 'Status do Serviços',  'icon' => 'file-code', 'url' => ['job-status/index'], 'visible' => \Yii::$app->user->can('indexJobStatusBackoffice')],
                    ['label' => 'Planos',  'icon' => 'file-code', 'url' => ['plan/index'], 'visible' => \Yii::$app->user->can('indexPlanBackoffice')],
                    ['label' => 'Denúncias',  'icon' => 'file-code', 'url' => ['report/index'], 'visible' => \Yii::$app->user->can('indexReportBackoffice')],
