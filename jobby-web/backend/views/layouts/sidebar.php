        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte\widgets\Menu::widget([
                'items' => [
                    ...
                    ['label' => 'Utilizadores',  'icon' => 'file-code', 'url' => ['user/index']],
                    ['label' => 'Serviços',  'icon' => 'file-code', 'url' => ['service/index']],
                    ['label' => 'Status do Serviços',  'icon' => 'file-code', 'url' => ['job-status/index']],
                    ['label' => 'Planos',  'icon' => 'file-code', 'url' => ['plan/index']],
                    //['label' => 'Avaliações',  'icon' => 'file-code', 'url' => ['avaliation/index']],
                    ['label' => 'Denúncias',  'icon' => 'file-code', 'url' => ['report/index']],
